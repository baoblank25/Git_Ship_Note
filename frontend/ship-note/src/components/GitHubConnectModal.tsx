        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-slate-900 dark:text-slate-100 text-xl">GitHub Integration</h2>
          ...
          {!isConnected ? (
            <div className="space-y-4">
              <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg">
                <h3 className="text-slate-900 dark:text-slate-100 mb-2">Connect Your GitHub Account</h3>
                <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">
                  Authorize GitScribe to access your repositories and pull commit history.
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-900 rounded-lg">
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  <strong>Demo Mode:</strong> This is using mock GitHub authentication. 
                  Real OAuth integration requires a secure backend (e.g., Supabase) to handle tokens safely.
                </p>
              </div>
            </div>
          ) : (
            <div className="space-y-6">
              ...
              <div className="p-4 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-900 rounded-lg flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="text-green-900 dark:text-green-100 mb-1">Connected as yourname</h3>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-slate-900 dark:text-slate-100">{repo.fullName}</span>
                          </div>
